...
const Navbar = () => {
    return (
        <div className='navbar w-full h-[65px] fixed top-0 shadow-lg shadow-[#F6FDFF]/40 bg-[#00091417] backdrop-blur-md z-50 px-6 md:px-10'>
            <div className='w-full h-full flex flex-row items-center justify-between m-auto px-[10px]'>
                <div className='h-auto w-auto flex flex-row items-center'>
                    <span className='font-butik text-xl md:text-2xl text-[#F6FDFF]'>
                        AW
                    </span>
                </div>
